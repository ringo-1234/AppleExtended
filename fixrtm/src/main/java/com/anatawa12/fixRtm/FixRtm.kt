...
object FixRtm {
    ...
    fun reportCrash(report: CrashReport) {
    ...
    fun registerGenerators() {
        ...
        val defaultResourcePacksField = runCatching {
            Minecraft::class.java.getDeclaredField("field_110449_ao")
        }.getOrElse {
            Minecraft::class.java.getDeclaredField("defaultResourcePacks")
        }.apply { isAccessible = true }

        @Suppress("UNCHECKED_CAST")
        val defaultResourcePacks = defaultResourcePacksField.get(mc) as MutableList<IResourcePack>
        defaultResourcePacks.add(GeneratedResourcePack)
