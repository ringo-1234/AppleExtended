...
val EntityPlayerMP.hasFixRTM get() = server?.isSinglePlayer == true || modList.containsKey(FixRtm.MODID)
...
fun Entity.rayTraceBothSide(blockReachDistance: Double, partialTicks: Float): RayTraceResult? {
    ...
    val endPosition = eyePosition
        .addVector(lookDir.x * blockReachDistance, lookDir.y * blockReachDistance, lookDir.z * blockReachDistance) // add -> addVector に変更
