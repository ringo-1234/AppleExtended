...
public class GuiSlotCustom
{
    ...
    protected void drawSlot(int par1, int par2, int par3, int par4, NGTTessellator par5, int par6, int par7)
    {
    	this.elements[par1].draw(this.mc, par2, par3, this.parentScreen.getZLevel());
    }

    protected void drawListHeader(int p_148129_1_, int p_148129_2_, NGTTessellator p_148129_3_) {}
    ...
    public void drawScreen(int p_148128_1_, int p_148128_2_, float p_148128_3_)
    {
        ...
        tessellator.addVertexWithUV((float)this.left, (float)(this.top + b0), z, 0.0F, 1.0F);
        tessellator.addVertexWithUV((float)this.right, (float)(this.top + b0), z, 1.0F, 1.0F);
        tessellator.setColorRGBA_I(0, 255);
        tessellator.addVertexWithUV((float)this.right, (float)this.top, z, 1.0F, 0.0F);
        tessellator.addVertexWithUV((float)this.left, (float)this.top, z, 0.0F, 0.0F);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setColorRGBA_I(0, 255);
        tessellator.addVertexWithUV((float)this.left, (float)this.bottom, z, 0.0F, 1.0F);
        tessellator.addVertexWithUV((float)this.right, (float)this.bottom, z, 1.0F, 1.0F);
        tessellator.setColorRGBA_I(0, 0);
        tessellator.addVertexWithUV((float)this.right, (float)(this.bottom - b0), z, 1.0F, 0.0F);
        tessellator.addVertexWithUV((float)this.left, (float)(this.bottom - b0), z, 0.0F, 0.0F);
        tessellator.draw();
        i3 = this.func_148135_f();
        ...
        if (i3 > 0)
        {
            ...
            NGTRenderHelper.addQuadGuiFaceWithUV(l, l2, i1, l2 + k2, z, 0.0F, 0.0F, 1.0F, 1.0F);
            tessellator.draw();
        ...
        for (int j1 = 0; j1 < i1; ++j1)
        {
            ...
            if (k1 <= this.bottom && k1 + l1 >= this.top)
            {
                if (this.showSelectionBox && this.isSelected(j1))
                {
                    ...
                    NGTRenderHelper.addQuadGuiFaceWithUV(i2, k1 - 2, j2, k1 + l1 + 2, z, 0.0F, 0.0F, 1.0F, 1.0F);
    ...
    private void overlayBackground(int y1, int y2, int alpha1, int alpha2)
    {
        ...
        tessellator.addVertexWithUV((float)this.left,                (float)y2, 0.0F, 0.0F,                    ((float)y2 / f));
        tessellator.addVertexWithUV((float)(this.left + this.width), (float)y2, 0.0F, ((float)this.width / f), ((float)y2 / f));
        tessellator.setColorRGBA_I(4210752, alpha1);
        tessellator.addVertexWithUV((float)(this.left + this.width), (float)y1, 0.0F, ((float)this.width / f), ((float)y1 / f));
        tessellator.addVertexWithUV((float)this.left,                (float)y1, 0.0F, 0.0F,                    ((float)y1 / f));
        tessellator.draw();
    }
    ...
    protected void drawContainerBackground()
    {
        ...
        NGTRenderHelper.addQuadGuiFaceWithUV(this.left, this.top, this.right, this.bottom, 0.0F,
        		(float)this.left / f1, (float)(this.top + (int)this.amountScrolled) / f1, (float)this.right / f1, (float)(this.bottom + (int)this.amountScrolled) / f1);
        tessellator.draw();
    }
