...
public class Face implements Cloneable
{
	...
	{
		TOP((x, y, z)   ->{return new float[]{1.0F - z, x};}),
		BOTTOM((x, y, z)->{return new float[]{z       , x};}),
		LEFT((x, y, z)  ->{return new float[]{1.0F - z, 1.0F - y};}),
		RIGHT((x, y, z) ->{return new float[]{z       , 1.0F - y};}),
		FRONT((x, y, z) ->{return new float[]{x       , 1.0F - y};}),
		BACK((x, y, z)  ->{return new float[]{1.0F - x, 1.0F - y};});
