...
public class EntityNPC extends EntityTameable implements IResourceSelector, IRangedAttackMob
{
    ...
    {
		return new PathNavigateGround(this, world);//レール通るため独自処理実装してた
    }*/
    ...
    {
		//インベントリ開いてる間は止まらせる
		if(this.inventory.isOpening){return;}
    ...
    {
		//updateEntityActionState()はOverrideできないの、ここで処理分け
