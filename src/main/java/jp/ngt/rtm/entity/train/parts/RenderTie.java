...
public class RenderTie extends Render<EntityTie>
{
	...
	public RenderTie(RenderManager renderManager)
	{
		super(renderManager);
	}
	...
	@Override
    public void doRender(EntityTie par1, double par2, double par4, double par6, float par8, float par9)
    {
        this.renderTie(par1, par2, par4, par6, par8, par9);
    }

    @Override
	protected ResourceLocation getEntityTexture(EntityTie entity)
	{
		return texture;
	}
