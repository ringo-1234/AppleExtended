...
public final class EntityFreightCar extends EntityTrainBase implements IInventory
{
	...
	private EntityCargo createCargoEntity(byte slot)
	{
		...
		switch(damage)
		{
		case 0: cargo = new EntityContainer(this.world, this, this.cargoSlots[slot], pos, slot);break;
		case 1: cargo = new EntityArtillery(this.world, this, this.cargoSlots[slot], pos, slot);break;
		case 2: cargo = new EntityTie(this.world,       this, this.cargoSlots[slot], pos, slot);break;
		default: cargo = new EntityContainer(this.world, this, this.cargoSlots[slot], pos, slot);break;
		}
