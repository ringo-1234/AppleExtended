...
public class ClientProxy extends CommonProxy
{
    ...
    {
    	if(!RTMCore.versionCheck){return;}

    	List<File> fileList = NGTFileLoader.findFile((file)->{return file.getName().startsWith("pack") && file.getName().endsWith(".json");});
    ...
    {
    	RTMSound.init();//このタイミングでないとResourceが未ロード?
    }
    ...
    public float getFov(EntityPlayer player, float fov)
	{
    	...
    	{
    	case ViewMode_Artillery: return 0.1F;
    	case ViewMode_SR: return 0.25F;
    	case ViewMode_AMR: return 0.1F;
    	case ViewMode_Camera: return Camera.INSTANCE.getFov();
    	default: return fov;
    	}
	}

    /**0:火砲, 1:狙撃銃, 2:AMR, 3:NVD, 4:Camera*/
    ...
    {
    	if(sound == null){NGTLog.debug("Proxy:Sound is null");return;}
