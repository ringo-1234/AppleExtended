...
public class GuiRTMWorkBench extends GuiContainerCustom implements IResourceSelector
{
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        {
        case 0: this.mc.getTextureManager().bindTexture(this.workbenchType == 1 ? tex_3 : tex_0);break;
        case 1: this.mc.getTextureManager().bindTexture(tex_1);break;
        case 2: this.mc.getTextureManager().bindTexture(tex_2);break;
        }
