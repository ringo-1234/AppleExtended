...
public class GuiItemContainer extends GuiContainer {
    ...
    public GuiItemContainer(EntityPlayer player, IInventory par2Inv) {
        super(new ContainerItemContainer(player, par2Inv));
        this.inventoryPlayer = player.inventory;
        this.inventory = par2Inv;
        this.allowUserInput = false;
        short short1 = 222;
        int i = short1 - 108;
        this.inventoryRows = par2Inv.getSizeInventory() / 9;
