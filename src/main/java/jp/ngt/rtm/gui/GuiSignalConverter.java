...
public class GuiSignalConverter extends GuiScreenCustom
{
	...
	public void initGui()
	{
		...
		this.signalValues[0] = this.setIntegerField(this.width / 2 - 20 + i0, 60, 40, 20, String.valueOf(ia[0]));
		if(this.scType == SignalConverterType.RSIn || this.scType == SignalConverterType.Wireless)
		{
			this.signalValues[1] = this.setIntegerField(this.width / 2 - 20 + i0, 100, 40, 20, String.valueOf(ia[1]));
		}
	}
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		{
			this.drawCenteredString(this.fontRenderer, "Output signal level" , this.width / 2, 30, 0xffffff);
			this.drawCenteredString(this.fontRenderer, "RS_ON" , this.width / 2, 45, 0xffffff);
			this.drawCenteredString(this.fontRenderer, "RS_OFF", this.width / 2, 85, 0xffffff);
		}
		else if(this.scType == SignalConverterType.RSOut)
		{
			this.drawCenteredString(this.fontRenderer, "Input signal level" , this.width / 2, 40, 0xffffff);
		}
		else if(this.scType == SignalConverterType.Wireless)
		{
			this.drawCenteredString(this.fontRenderer, "Channel" , this.width / 2, 45, 0xffffff);
			this.drawCenteredString(this.fontRenderer, "Chunk Load Range", this.width / 2, 85, 0xffffff);
		}
	}
}