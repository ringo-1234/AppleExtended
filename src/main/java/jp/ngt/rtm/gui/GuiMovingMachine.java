...
public class GuiMovingMachine extends GuiScreenCustom {
    ...
    public void initGui() {
        ...
        this.range[0] = this.setTextField(hw - 120, h, 60, 20, String.valueOf(this.tileEntity.width));
        h += 24;
        this.range[1] = this.setTextField(hw - 120, h, 60, 20, String.valueOf(this.tileEntity.height));
        h += 24;
        this.range[2] = this.setTextField(hw - 120, h, 60, 20, String.valueOf(this.tileEntity.depth));
        h += 24;
        ...
        if (this.blockType == 0) {
            ...
            this.buttonType = this.addButton(new GuiButton(101, w, h, 100, 20, VEHICLE_TYPE[this.tileEntity.vngto.type]));
            h += 24;
            this.type = this.tileEntity.vngto.type;

            this.offset = new GuiTextField[3];
            this.offset[0] = this.setTextField(w, h, 60, 20, String.valueOf(this.tileEntity.offsetX));
            h += 24;
            this.offset[1] = this.setTextField(w, h, 60, 20, String.valueOf(this.tileEntity.offsetY));
            h += 24;
            this.offset[2] = this.setTextField(w, h, 60, 20, String.valueOf(this.tileEntity.offsetZ));
            h += 24;
            ...
            this.vngtoSetting[0] = this.setTextField(w, h, 60, 20, String.valueOf(this.tileEntity.vngto.scale));
            h += 24;
            this.vngtoSetting[1] = this.setTextField(w, h, 60, 20, String.valueOf(f1));
            h += 24;
            this.vngtoSetting[2] = this.setTextField(w, h, 60, 20, String.valueOf(f2));
            h += 24;
            this.vngtoSetting[3] = this.setTextField(w, h, 60, 20, String.valueOf(f3));
            h += 24;
        }
    }
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        int h = 56;
        this.drawString(this.fontRenderer, "Width", w2 - 160, h, 0xFFFFFF);
        h += 24;
        this.drawString(this.fontRenderer, "Height", w2 - 160, h, 0xFFFFFF);
        h += 24;
        this.drawString(this.fontRenderer, "Depth", w2 - 160, h, 0xFFFFFF);
        h += 24;
        ...
        if (this.blockType == 0) {
            ...
            h += 24;
            this.drawString(this.fontRenderer, "OffsetX", w2, h, 0xFFFFFF);
            h += 24;
            this.drawString(this.fontRenderer, "OffsetY", w2, h, 0xFFFFFF);
            h += 24;
            this.drawString(this.fontRenderer, "OffsetZ", w2, h, 0xFFFFFF);
            h += 24;
            this.drawString(this.fontRenderer, "Scale", w2, h, 0xFFFFFF);
            h += 24;
            this.drawString(this.fontRenderer, "VehicleOffsetX", w2, h, 0xFFFFFF);
            h += 24;
            this.drawString(this.fontRenderer, "VehicleOffsetY", w2, h, 0xFFFFFF);
            h += 24;
            this.drawString(this.fontRenderer, "VehicleOffsetZ", w2, h, 0xFFFFFF);
            h += 24;
        }
    }
}