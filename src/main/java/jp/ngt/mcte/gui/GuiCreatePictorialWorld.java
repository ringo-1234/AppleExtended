...
public class GuiCreatePictorialWorld extends GuiScreenCustom
{
	...
	public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawString(this.fontRenderer, I18n.format("gui.mcte.biomesImage"), i0 + 5, 25, 0xffffff);
        this.drawString(this.fontRenderer, I18n.format("gui.mcte.baseBlock"), i0 + 5, 45, 0xffffff);

        this.drawString(this.fontRenderer, I18n.format("gui.mcte.minY"), i0 + 5, 65, 0xffffff);
        this.drawString(this.fontRenderer, I18n.format("gui.mcte.yScale"), i0 + 5, 85, 0xffffff);
        this.drawString(this.fontRenderer, I18n.format("gui.mcte.seaLevel"), i0 + 5, 105, 0xffffff);
