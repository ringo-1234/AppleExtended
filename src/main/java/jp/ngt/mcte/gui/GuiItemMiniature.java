...
public class GuiItemMiniature extends GuiScreenCustom
{
	...
	private GuiTextField fieldLightValue, fieldAABB, fieldMoveOption;
	...
	private float getFloat(String s)
	{
		...
		if(f == Float.NaN){throw new NumberFormatException();}
		return f;
	}
	...
	private byte getByte(String s)
	{
		...
		if(b < 0 || b > 15){throw new NumberFormatException();}
		return b;
	}
	...
	private void selectFile()
	{
		...
		if(file != null)
		{
			NGTObject obj = NGTObject.importFromFile(file, this.scale);
			this.ngto = obj;
	...
	private void sendPacket()
	{
		if(this.ngto != null)
		{
			...
			this.state.setMotion(this.fieldMoveOption.getText());
	...
	public void drawScreen(int par1, int par2, float par3)
    {
        ...
        int i2 = hw + 5;
        int i3 = 45;
        this.drawString(this.fontRenderer, "Scale",		i2, i3,      0xFFFFFF);
        this.drawString(this.fontRenderer, "OffsetX",	i2, i3 + 20, 0xFF0000);
        this.drawString(this.fontRenderer, "OffsetY",	i2, i3 + 40, 0x00FF00);
        this.drawString(this.fontRenderer, "OffsetZ",	i2, i3 + 60, 0x0000FF);
        this.drawString(this.fontRenderer, "Brightness",	hw, i3 + 80, 0xFFFFFF);
    }
}